...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivProfilePicture.setOnClickListener(View.OnClickListener {
            checkPermission()
        })
    ...
    fun SaveImageInFirebase() {
        ...
        ivProfilePicture.isDrawingCacheEnabled = true
        ivProfilePicture.buildDrawingCache()

        val drawable = ivProfilePicture.drawable as BitmapDrawable
